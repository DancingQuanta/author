...
\DeclareSourcemap{\maps[datatype=bibtex]{\map{\step[fieldsource=file, match=\regexp{:home/srey/TRAVAUX/THESE/REPOSITORY_PDF/RANGE/(.+):pdf}, replace={http://www.example.com/$1}]}}}
\DeclareFieldFormat{file}{\href{#1}{Open file}}
$for(bibliography)$
